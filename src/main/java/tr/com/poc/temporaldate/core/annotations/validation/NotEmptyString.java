...
import tr.com.poc.temporaldate.core.validation.validator.NotEmptyStringValidator;

/**
 * The annotated element must be a String type. Compares whether the element has an empty string value or not.
 * <p/>
...
public @interface NotEmptyString
{
	...
	String message() default "{0} is empty string but it shouldnot be";
