...
@Log4j2
public abstract class BaseAuditedDaoImpl<E extends BaseAuditedEntity> implements BaseDao
{
	...
	private <E2 extends BaseAuditedEntity> void callSettersOnObjectWithoutNullAndIdFields(E2 be, E2 newValues)
	{
		Class beType = (Class<E>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0];
		for (Field field : beType.getDeclaredFields())
		{
